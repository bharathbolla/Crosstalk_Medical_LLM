"""
Fixed Kaggle Notebook Generator
Creates proper notebook format without double-escaped newlines
"""
...
def create_notebook():
    """Generate Kaggle notebook with proper formatting."""
    ...
    # Save
    with open('KAGGLE_FIXED.ipynb', 'w', encoding='utf-8') as f:
        json.dump(notebook, f, indent=2, ensure_ascii=False)

    print('✅ Fixed notebook created: KAGGLE_FIXED.ipynb')
    print('\nChanges:')
    print('  - Proper newline handling (no double-escaping)')
    print('  - Clean source format')
