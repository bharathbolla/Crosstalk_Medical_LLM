        ...
        "cells": [
            ...
            },
            {
                ...
                "source": [
                    ...
                    "    incremental_csv = RESULTS_DIR / f'results_incremental_{EXPERIMENT_ID}.csv'\n",
                    ...
                    "            df_incremental.to_csv(RESULTS_DIR / f'results_incremental_{EXPERIMENT_ID}.csv', index=False)\n",
                    "            \n",
                    "            # Save epoch-level results\n",
                    "            if epoch_results:\n",
                    "                df_epochs = pd.DataFrame(epoch_results)\n",
                    "                epoch_csv = RESULTS_DIR / f'epoch_results_{EXPERIMENT_ID}.csv'\n",
                    ...
                    "                results_src = RESULTS_DIR\n",
                    "                results_dst = repo_dir / 'results'\n",
                    "                results_dst.mkdir(exist_ok=True)\n",
                    "                # Copy CSVs to repo\n",
                    "                import shutil\n",
                    "                for csv_file in results_src.glob('*.csv'):\n",
                    "                    shutil.copy2(csv_file, results_dst / csv_file.name)\n",
                    "                # Git add, commit, push\n",
                    "                subprocess.run(['git', 'add', 'results/'], cwd=str(repo_dir))\n",
                    "                subprocess.run(['git', 'commit', '-m', f'Results: {primary_dataset} complete ({EXPERIMENT_ID})'], cwd=str(repo_dir))\n",
